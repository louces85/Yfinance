...
- Ratio: 6,04 / 2,81 = **2,2×** → flag ativado

VULC3 2025:
- ML 2025: 32,73%
- ML média 2021–2024: 17,90%
- Ratio: 32,73 / 17,90 = **1,83×** → flag ativado (receita cresceu 16,8%, mas não explica quase dobrar a margem)
...
|-----------|-------|--------------|
| Ratio ML mínimo para spike | **1,8×** | Captura spikes como ALLD3 2025 (2,2×) e VULC3 2025 (1,83×) |
...
**2026-04:** Removida a condição de receita estagnada (`rec_growth < 10%`).

Motivo: VULC3 2025 tinha ML 32,7% vs média anterior de 17,9% (ratio 1,83×), mas a receita cresceu 16,8% — acima do limiar — o que bloqueava o flag incorretamente. O crescimento de receita de 16,8% **não explica** ML quase dobrar; alavancagem operacional típica gera 1–3 p.p. de melhora de margem, não 15 p.p. O flag é informacional, então é mais seguro sinalizar e deixar o analista julgar do que silenciar o aviso por crescimento de receita.

> **Nota:** O flag detecta o *sintoma* (spike de ML), não a causa. Pode ativar em turnarounds legítimos. Sempre validar contra as notas dos demonstrativos financeiros.
